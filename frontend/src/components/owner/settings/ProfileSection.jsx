...
import { updateRestaurantProfile } from "../../../redux/thunks/settingThunk.js";
import { resetSettingLoadState } from "../../../redux/features/owner/settingLoadSlice";
...
const { loading, error, success, reqtype } = useSelector(
...
useEffect(() => {
  if (reqtype !== "updateRestaurantProfile") return;
          ...
          <div className="flex justify-end gap-3 mt-8">
            {!isEditing ? (
              ...
              <>
                ...
                <button
  onClick={handleSave}
  disabled={loading && reqtype === "updateRestaurantProfile"}
...
>
  {loading && reqtype === "updateRestaurantProfile" ? (
    <>
