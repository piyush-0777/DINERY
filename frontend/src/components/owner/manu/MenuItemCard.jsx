    ...
    <div className="flex-1 flex flex-col justify-between ml-4 relative">
      ...
      <div className="absolute top-0 right-0 flex gap-2 opacity-0 group-hover:opacity-100 transition-all duration-300 z-20">
        <button
          ...
          className="p-2 rounded-full bg-black/70 backdrop-blur-md border border-yellow-400/40
          text-yellow-400 hover:bg-yellow-500 hover:text-black transition"
        >
          <Pencil size={14} />
        </button>
        ...
        <button
          ...
          className="p-2 rounded-full bg-black/70 backdrop-blur-md border border-red-400/40
