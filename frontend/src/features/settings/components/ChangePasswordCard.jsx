...
import { useUpdatePassword, SettingsCard } from "../index.js";
export default function ChangePasswordCard() {
  ...
  const handleUpdate = async () => {
    ...
    try {
      const result = await updatePassword.UpdatePassword({
...
function PasswordInput({ label, name, value, show, setShow, onChange }) {
  return (
    <div>
