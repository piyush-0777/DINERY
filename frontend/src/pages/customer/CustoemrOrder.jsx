...
const CustomerOrder = () => {
  ...
  const [status, setStatus] = useState(placedOrder?.order?.status || "pending");
    ...
    <div className="min-h-screen bg-gray-100 flex justify-center">
      <div className="w-full max-w-[430px]">
        ...
        <div className="sticky top-0 bg-white shadow-sm z-20">
          <div className="flex items-center gap-3 p-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">Track your order live</p>
            </div>
          </div>
        </div>
        ...
        <div className="p-4 space-y-5 pb-28">
          ...
          {status === "completed" && <PayNowCard bill={bill} />}

          {/* Cancel */}

          {status === "cancelled" && (
            <div className="bg-red-50 border border-red-300 rounded-3xl p-5">
              <h2 className="font-bold text-red-600">Order Cancelled</h2>
