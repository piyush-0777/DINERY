...
import { Button, useCustomerLogin , addToken } from "../../features/customer";
...
const CustomerLogin = () => {
  ...
  const onSubmit = async (data) => {
    try {
      const result = await customerLogin.customerLogin({
        resturantName: resturantName,
        customerName: data.name,
        CustomerMobile: data.number,
        token: customerDeteal.token,
      });
  ...
  return (
    <div>
      ...
      <div className="w-[100%] flex flex-col items-center gap-3">
        ...
        <div className="w-[100%]">
          <form
            className="flex  flex-col gap-2 w-[90%]  items-start ml-4 "
          ...
          >
            ...
            <div className="w-full h-10 mt-5">
              ...
              className="w-full h-10"
                ButtonName={
                  customerLogin.loading === true ? "loding..." : "Log in"
                }
              />
            </div>
          </form>
